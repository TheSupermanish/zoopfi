...
export default (mongoose.models.GroupInvitation || mongoose.model<IGroupInvitation>('GroupInvitation', GroupInvitationSchema)) as mongoose.Model<IGroupInvitation>;
